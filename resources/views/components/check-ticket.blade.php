<div x-data="ticket" class="flex items-end justify-center min-h-screen md:px-4 text-center items-center sm:block sm:p-0">
    ...
    <div x-cloak x-show="ticket" 
        ...
        class="inline-block w-full max-w-xl p-8 md:my-20 overflow-hidden text-left transition-all transform bg-[#1a1c23] rounded-lg shadow-xl 2xl:max-w-4xl" 
    >
        ...
        <div class="flex flex-col overflow-y-auto md:flex-row items-center">
          <div class="md:h-32 md:h-auto md:w-1/3 w-full">
            <div class="w-full flex justify-center ">
                <div class="w-2/3 border-b-2 md:border-b-0 border-white">
                    ...
                    <p class="mt-2 text-sm text-gray-400 mb-5 md:mb-0">
          ...
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-2/3 w-full md:border-l-2 border-white">
