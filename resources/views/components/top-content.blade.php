<div>
    <div class="relative items-center justify-center w-full overflow-x-hidden pb-20 lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64">
        <div
            ...
            <div class="lg:flex w-full mt-1 lg:mt-5">
                ...
                <iframe width="700" height="300" src="https://www.youtube.com/embed/3RQVULdZVX0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                <div class="hidden lg:flex w-full justify-center rounded-lg lg:mt-1">
                <iframe width="700" height="500" src="https://www.youtube.com/embed/3RQVULdZVX0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
