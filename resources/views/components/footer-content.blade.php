    ...
    <div class="container flex flex-col justify-between max-w-6xl px-4 mx-auto overflow-hidden lg:flex-row">
        <div class="flex w-auto items-center pl-12 mr-4 text-left sm:text-center sm:pl-0 lg:text-left">
            <a href="/"
                ...
                <span class="flex items-start sm:items-center sm:w-40 w-20 h-auto">
                    <x-logo01 />
                </span>
            </a>
        ...
        <!-- <div class="block w-auto pl-10 mt-6 text-sm  sm:flex lg:mt-0">
            <ul class="flex flex-col w-full p-0 font-medium items-center text-center text-gray-700 list-none">
