...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  ...
  <body>
    ...
    @if(session('success'))
      <div class="bg-white z-10 max-w-md fixed right-0 top-0 rounded-lg p-6 shadow">
      <h1 class="text-xl text-slate-700 font-medium">Login attempt failed 🚫</h1>
      </div>
    @endif
      ...
      >
        <div class="flex flex-col overflow-y-auto md:flex-row items-center">
          ...
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <form class="w-full" method="post" action="/signin" enctype="multipart/form-data">
            {{ csrf_field() }}
              <h1
